def micrRecognition(path):
    ...
    def main():
        ...
        try:
            npaClassifications = np.loadtxt("GenDataTrainedInput1ClassificationsInput.txt", np.float32)
        except:
        ...
        try:
            npaFlattenedImages = np.loadtxt("GenDataTrainedInput1FlattenedImagesInput.txt", np.float32)
        except:
